NAME = uls
SRC = src/main.c src/mx_error_flag.c src/mx_print_error_flags.c src/mx_error_dir.c src/mx_ls_no_flags.c src/mx_print_dir.c src/mx_sort_dir.c src/mx_loop_print.c src/mx_find_flag.c src/mx_free_void_arr.c src/mx_ls_flag_a.c src/mx_ls_flag__A.c src/mx_ls_show_directory.c src/mx_winsize.c src/mx_print_error.c src/mx_free_dir.c src/mx_print_dir_flag_G.c src/mx_print_dir_new_line.c
